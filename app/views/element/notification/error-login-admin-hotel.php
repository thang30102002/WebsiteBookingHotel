    ...
    <div class="container">
        <div class="form-container">
            ...
            <form method="post" action="">
                ...
                <button type="submit" name='login-admin-hotel'>Đăng nhập</button>
                <p style="    text-align: center;
    color: red;
    padding: 10;">Tài khoản hoặc mật khẩu không đúng, xin vui lòng nhập lại!</p>
            </form>
            <p>Chưa phải là đối tác? <a href="RegisterAdminHotel">Đăng ký tại đây</a></p>
