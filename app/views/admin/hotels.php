...
<body>
    ...
    display: flex;">
								<h4 class="card-title float-left mt-2">Danh sách khách sạn</h4>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class='text-right'>
                                                                <div class='dropdown dropdown-action'> <a href='#' class='action-icon dropdown-toggle' data-toggle='dropdown' aria-expanded='false'><i class='fas fa-ellipsis-v ellipse_color'></i></a>
                                                                    <div class='dropdown-menu dropdown-menu-right'> <a class='dropdown-item' href='editBooking?hotel_id=".$data['hotel'][$i]['hotel_id']."'><i class='fas fa-pencil-alt m-r-5'></i> Edit</a> <a class='dropdown-item' href='#' data-toggle='modal' data-target='#delete_asset_".$data['hotel'][$i]['hotel_id']."'><i class='fas fa-trash-alt m-r-5'></i> Delete</a> </div>
                                                                </div>
                                                        </td>
                                                        
                                                    </tr>
													<div id='delete_asset_".$data['hotel'][$i]['hotel_id']."' class='modal fade delete-modal' role='dialog'>
                                                            ...
                                                            <div class='modal-content'>
                                                                <div class='modal-body text-center'> <img src='../app/views/admin_dashbaord-_hotel_bootstrap5-main/assets/img/sent.png' alt='' width='50' height='46'>
                                                                    <h3 class='delete_class'>Bạn có đồng ý xoá đơn đặt phòng này ?</h3>
                                                                            ...
                                                                            <form method='post'>
                                                                                <input type='hidden' name='id_booking_delete' value='".$data['hotel'][$i]['hotel_id']."'>
																				
                                                                                <button name ='delete_booking' type='submit' class='btn btn-danger'>Delete</button>
                                                                            </form>
