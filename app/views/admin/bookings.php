...
<body>
    ...
    display: flex;">
								<h4 class="card-title float-left mt-2">Danh sách đơn đặt phòng</h4>
										...
										<tbody>
                                            ...
                                            <?php
                                                ...
                                                for($i=0;$i<count($data['bookings']);$i++)
                                                {
                                                    ...
                                                    $hotel = $this->Hotel->getHotelDetail($room['hotel_id']);
                                                    $dem=$dem+1;
													$status="";
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>".$data['bookings'][$i]['check_in_date']."</td>
                                                        <td>".$data['bookings'][$i]['check_out_date']."</td>
                                                        ...
                                                        <td class='text-right'>
                                                                <div class='dropdown dropdown-action'> <a href='#' class='action-icon dropdown-toggle' data-toggle='dropdown' aria-expanded='false'><i class='fas fa-ellipsis-v ellipse_color'></i></a>
                                                                    <div class='dropdown-menu dropdown-menu-right'> <a class='dropdown-item' href='editBooking?booking_id=".$data['bookings'][$i]['booking_id']."'><i class='fas fa-pencil-alt m-r-5'></i> Edit</a> <a class='dropdown-item' href='#' data-toggle='modal' data-target='#delete_asset_".$data['bookings'][$i]['booking_id']."'><i class='fas fa-trash-alt m-r-5'></i> Delete</a> </div>
                                                                </div>
                                                        </td>
                                                            ...
                                                            <div class='modal-content'>
                                                                <div class='modal-body text-center'> <img src='../app/views/admin_dashbaord-_hotel_bootstrap5-main/assets/img/sent.png' alt='' width='50' height='46'>
                                                                    <h3 class='delete_class'>Bạn có đồng ý xoá đơn đặt phòng này ?</h3>
                                                                            ...
                                                                            <form method='post'>
                                                                                <input type='hidden' name='id_booking_delete' value='".$data['bookings'][$i]['booking_id']."'>
